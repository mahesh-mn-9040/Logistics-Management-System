...
$sql = "SELECT order_id, order_date, client_name, client_contact, payment_status FROM orders WHERE order_status = 1 AND companyid='$companyid'";
...
if($result->num_rows > 0) { 
 ...
 while($row = $result->fetch_array()) {
 	...
 	$countOrderItemSql = "SELECT count(*) FROM order_item WHERE order_id = $orderId AND companyid='$companyid'";
